  ...
  return (
    <Paper elevation={2} className={cssClasses.Row}>
      <Grid container>
        ...
        <Grid item sm={1} xs={4}><div className={cssClasses.bold}>{props.day}%</div> <div>1D</div></Grid>
        <Grid item sm={1} xs={4}><div className={cssClasses.bold}>{props.year}%</div> <div>1Y</div></Grid>
        <Grid item sm={1} xs={4}><div className={cssClasses.bold}>{props.year3}%</div> <div>3Y</div></Grid>
      </Grid>
    </Paper>
  );
};
